...
const Header = ({
    ...
    return (
        <header
            className={`${weekPlanLength === 0 ? "bg-white" : "bg-[#CEE422]"
        ...
        >
                    ...
                    <SignedIn>
                        {weekPlanLength > 0 && (
                            <>
                                ...
                                <button onClick={handlePersonalTrainerClick}                                className="bg-black text-white px-4 py-2 rounded hover:bg-gray-800 transition-colors duration-200">
                                    Фитнес
                                </button>
                            </>
                        )}
            ...
            {/* Mobile Menu Content */}
            <div
                className={`md:hidden fixed top-0 right-0 h-full w-64 bg-white shadow-lg transform ${isMenuOpen ? "translate-x-0" : "translate-x-full"
                    ...
                    <SignedIn>
                        ...
                        {weekPlanLength > 0 && (
                            <div className="flex flex-col gap-4 mt-4">
                                ...
                                <button
                                    onClick={handleEatInCafeClick}
                                    className={`bg-green-800 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors duration-200 ${loading ? "opacity-50 cursor-not-allowed" : ""
