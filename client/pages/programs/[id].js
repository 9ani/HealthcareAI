...
const Accordion = styled(MuiAccordion)(({ theme }) => ({
  ...
  backgroundColor: "#3F3F3F", // Background color
  "&:not(:last-child)": {
    borderBottom: 0,
  },
  "&:before": {
...
const AccordionSummary = styled(MuiAccordionSummary)(({ theme }) => ({
  backgroundColor: "#3F3F3F", // Match background with Accordion
  ...
  "& .MuiAccordionSummary-content": {
    ...
    fontWeight: "bold", // Make text more noticeable
  },
}));

const AccordionDetails = styled(MuiAccordionDetails)(({ theme }) => ({
  padding: theme.spacing(2),
  borderTop: "1px solid white", // White border for details
  color: "white", // White text inside AccordionDetails
  backgroundColor: "#3F3F3F", // Match background with Accordion
  color: "white", 
  "& .MuiTypography-root": {   // Target Typography specifically in AccordionDetails
      ...
      weekPlan: [
          {
              ...
              recommendations: [
                  {
                      name: "Жим штанги",
                      youtubeLink: "https://www.youtube.com/watch?v=Jb2bMaxqnXI"
                  },
                  {
                      name: "Жим гантелей",
    ...
    <div className="bg-black pt-12 pb-12 min-h-screen flex flex-col">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-12 px-4 md:px-12 mt-8 md:mt-24 flex-grow">
        <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-col md:flex-row gap-4 h-[500px]">
              ...
              {currentDayIndex === userDayNumber - 1 && (
                <button
                  ...
                  className="w-full mr-[50px] bg-green-400 text-white font-extrabold text-3xl py-4 px-8 rounded-xl hover:bg-green-500 transition-colors"
                >
                  Начать занятие
                </button>
              )}{" "}
          ...
          {sportPlan.length > 0 && (
            <div className="ml-16 text-[#FFFFFF] ">
              <h2 className={`text-4xl font-bold text-[#FFFFFF] mb-4 mt-4`}>
