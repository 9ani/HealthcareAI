...
const Program = ({ title, description, imageSrc }) => (
...
const IndexPage = () => {
  ...
  const programs = [
    {
      title: "БЕГ",
      description: "Кардио-тренировка для сжигания калорий и укрепления сердечно-сосудистой системы.",
      imageSrc: "/images/RunningPhoto.png"
    },
    {
      title: "СИЛОВЫЕ",
      description: "Упражнения с весами направленные на развитие мышечной силы и выносливости.",
      imageSrc: "/images/PlyoPhoto.png"
    },
    {
      title: "СТРЕТЧИНГ",
      description: "Растягивающие упражнения для повышения гибкости и улучшения подвижности суставов.",
          ...
          <div className="w-full lg:w-1/2 px-8 lg:px-16 py-12 order-1 lg:order-2">
            ...
            <div className="w-full ">
              <button
                ...
                className="w-20% bg-[#DAF23D] text-custom-green rounded-lg text-xl font-bold py-4 px-8 transition duration-300 ease-in-out hover:bg-[#92a339] hover:shadow-lg"
              >
                Создать план
              </button>
            </div>
